...
<head>
    ...
    <!-- educate icon CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo site_url();?>css/educate-custon-icon.css">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo site_url();?>css/morrisjs/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo site_url();?>css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo site_url();?>css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="<?php echo site_url();?>css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo site_url();?>css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="<?php echo site_url();?>css/calendar/fullcalendar.print.min.css">
    <!-- style CSS
		============================================ -->
...
<body>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="<?php echo site_url();?>js/counterup/jquery.counterup.min.js"></script>
    <script src="<?php echo site_url();?>js/counterup/waypoints.min.js"></script>
    <script src="<?php echo site_url();?>js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="<?php echo site_url();?>js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="<?php echo site_url();?>js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="<?php echo site_url();?>js/metisMenu/metisMenu.min.js"></script>
    <script src="<?php echo site_url();?>js/metisMenu/metisMenu-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="<?php echo site_url();?>js/morrisjs/raphael-min.js"></script>
    <script src="<?php echo site_url();?>js/morrisjs/morris.js"></script>
    <script src="<?php echo site_url();?>js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="<?php echo site_url();?>js/sparkline/jquery.sparkline.min.js"></script>
    <script src="<?php echo site_url();?>js/sparkline/jquery.charts-sparkline.js"></script>
    <script src="<?php echo site_url();?>js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
    <script src="<?php echo site_url();?>js/calendar/moment.min.js"></script>
    <script src="<?php echo site_url();?>js/calendar/fullcalendar.min.js"></script>
    <script src="<?php echo site_url();?>js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
		============================================ -->
    ...
    <!-- tawk chat JS
		============================================ -->
    <script src="<?php echo site_url();?>js/tawk-chat.js"></script>
</body>
